...
def process_kidney_dataset():
    """
    Process all images in the Kidney_preprocessed dataset by cropping them
    and replacing the original images with the cropped versions.
    """
    # Path to the Kidney_preprocessed dataset
    dataset_path = "Datasets_preprocessed/Kidney_preprocessed"
